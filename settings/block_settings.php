...
//TODO it has to be changed for generate link
        // Add new link
        $s='<p class="tree_item leaf"><a href="http://moodle/my/">
            <img alt="" class="smallicon" title="" src="http://moodle/theme/image.php/standard/core/1414609797/i/settings">
            Sylka Page</a></p>';
        $this->content->text .= $s;
